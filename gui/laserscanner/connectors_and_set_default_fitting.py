class initialize_connections_and_defaultvalue:
    def initialize_connections_and_defaultvalues(self):
        ...
        self._mw.fit_methods_ComboBox.activated.connect(self._voltscan_logic.fit_methods_ComboBox_StateChanged)
    ...
    def disconnect_all(self):
        ...
        self._mw.fit_methods_ComboBox.stateChanged.disconnect()

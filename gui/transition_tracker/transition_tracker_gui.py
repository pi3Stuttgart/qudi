...
class TransitionTrackerGui(GUIBase):
    ...
    def update_gui_electron(self):
        self.current_local_oscillator_freq_text_field.setText("{:.10f}".format(self._transition_tracker.current_local_oscillator_freq))
        self.current_local_oscillator_freq_p1_text_field.setText("{:.10f}".format(self._transition_tracker.current_local_oscillator_freq_p1))
        self.mw_mixing_frequency_text_field.setText("{:.10f}".format(self._transition_tracker.mw_mixing_frequency))
        self.mw_mixing_frequency_p1_text_field.setText("{:.10f}".format(self._transition_tracker.mw_mixing_frequency_p1))
        self.mw_transition_frequency_text_field.setText("{:.10f}".format(self._transition_tracker.mw_transition_frequency))
        self.mw_transition_frequency_p1_text_field.setText("{:.10f}".format(self._transition_tracker.mw_transition_frequency_p1))
        self.zero_field_splitting_text_field.setText("{:.10f}".format(self._transition_tracker.zero_field_splitting))
        self.ple_Ex_text_field.setText("{:.10f}".format(self._transition_tracker.ple_Ex))
        self.ple_A1_text_field.setText("{:.10f}".format(self._transition_tracker.ple_A1))
    ...
    def update_gui_nuclear(self):
        ...
        self.script_queue_table.setEnabled(True)
        self.script_queue_table.setRowCount(len(self._transition_tracker.transitions))

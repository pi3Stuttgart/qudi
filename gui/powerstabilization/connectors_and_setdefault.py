...
class powerstab_default_gui():
        def initialize_connections_and_defaultvalues(self):
                ...
                self._mw.A1Voltage_LineEdit.textEdited.connect(self._power_stabilization.A1Voltage_LineEdit_textEdited,type=QtCore.Qt.QueuedConnection)
                self._mw.A2Voltage_LineEdit.textEdited.connect(self._power_stabilization.A2Voltage_LineEdit_textEdited,type=QtCore.Qt.QueuedConnection)
                ...
                self._mw.A1Voltage_PushButton.clicked.connect(self._power_stabilization.A1Voltage_PushButton_Clicked,type=QtCore.Qt.QueuedConnection)
                self._mw.A2Voltage_PushButton.clicked.connect(self._power_stabilization.A2Voltage_PushButton_Clicked,type=QtCore.Qt.QueuedConnection)
                ...
                self._mw.On_RadioButton.clicked.connect(self._power_stabilization.On_RadioButton_clicked,type=QtCore.Qt.QueuedConnection)
                self._mw.Off_RadioButton.clicked.connect(self._power_stabilization.Off_RadioButton_clicked,type=QtCore.Qt.QueuedConnection)
                self._mw.A1_RadioButton.clicked.connect(self._power_stabilization.A1_RadioButton_clicked,type=QtCore.Qt.QueuedConnection)
                self._mw.A2_RadioButton.clicked.connect(self._power_stabilization.A2_RadioButton_clicked,type=QtCore.Qt.QueuedConnection)

...
class TimeTaggerLogic(GenericLogic):
    ...
    def init_plots(self):
        ...
        self.time_hist = np.linspace(0,self.hist_params['number_of_bins']*self.hist_params['binwidth']/1000, self.hist_params['number_of_bins'])
        self.time_corr = np.linspace(-0.5*self.corr_params['number_of_bins']*self.corr_params['binwidth']/1000,
                                        0.5*self.corr_params['number_of_bins']*self.corr_params['binwidth']/1000,

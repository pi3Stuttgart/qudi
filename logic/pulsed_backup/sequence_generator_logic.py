...
class SequenceGeneratorLogic(GenericLogic):
    ...
    # def _restore_saved_blocks(self, block_list):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',0)
    ...
    # def _convert_saved_blocks(self, block_dict):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',1)
    ...
    # def _restore_saved_sequences(self, sequence_list):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',2)
    ...
    # def _convert_saved_sequences(self, sequence_dict):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',3)
    ...
    def sampled_sequences(self):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',4)
        return netobtain(self.pulsegenerator().get_sequence_names())

    @property
    def analog_channels(self):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',5)
        print(self.__activation_config[1], 'GENERATOR LOGIC ANALOG channels')###UNFUG
        return {chnl for chnl in self.__activation_config[1] if chnl.startswith('a_ch')}

    @property
    def digital_channels(self):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',6)
        print(self.__activation_config[1], 'GENERATOR LOGIC DIGITAL channels')###UNFUG
        ...
        if pulser_status == 0:
            ...
            if 'activation_config' in settings_dict:
                ...
                for name in [setting for setting in self.generation_parameters if
                    ...
                    print(channel, 'GENERATOR LOGIC set_pulse_generator_settings')###UNFUG
    ...
    def load_sequence(self, sequence):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',7)
        """

        @param str|PulseSequence sequence:
        """
        print(sequence, 'GENERATOR LOGIC load_sequence')###UNFUG
    ...
    def saved_pulse_blocks(self):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',8)
        return self._saved_pulse_blocks

    @property
    def saved_pulse_block_ensembles(self):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',9)
        return self._saved_pulse_block_ensembles

    @property
    def saved_pulse_sequences(self):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',10)
    ...
    def save_block(self, block):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',11)
        ...
        print(self._saved_pulse_blocks, 'GENERATOR LOGIC save_block')###UNFUG
        return

    def get_block(self, name):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',12)
        """
    ...
    def delete_block(self, name):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',13)
    ...
    def _load_block_from_file(self, block_name):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',14)
        """
    ...
    def _update_blocks_from_file(self):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',15)
        """
    ...
    def _save_block_to_file(self, block):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',16)
        """
    ...
    def _save_blocks_to_file(self):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',17)
        """
    ...
    def save_sequence(self, sequence):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',18)
    ...
    def get_sequence(self, name):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',19)
        """
    ...
    def delete_sequence(self, name):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',20)
        """
    ...
    def _load_sequence_from_file(self, sequence_name):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',21)
        """
    ...
    def _update_sequences_from_file(self):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',22)
        """
    ...
    def _save_sequence_to_file(self, sequence):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',23)
        """
    ...
    def _save_sequences_to_file(self):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',24)
        """
    ...
    def generate_predefined_sequence(self, predefined_sequence_name, kwargs_dict):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',25)
        """
    ...
    def _add_default_sequence(self, ensembles, sequences):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',26)
    ...
    def get_sequence_info(self, sequence):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',27)
        """
    ...
    def analyze_block_ensemble(self, ensemble):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',28)
        """
    ...
    def analyze_sequence(self, sequence):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',29)
        """
    ...
    def _sampling_ensemble_sanity_check(self, ensemble):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',30)
        blocks_missing = set()
    ...
    def _sampling_sequence_sanity_check(self, sequence):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',31)
    ...
    def sample_pulse_block_ensemble(self, ensemble, offset_bin=0, name_tag=None):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',32)
    ...
    def sample_pulse_sequence(self, sequence):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',33)
    ...
    def _delete_sequence(self, names):
        print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',34)
        if isinstance(names, str):
            names = [names]
    ...
    def _sample_load_benchmark_chunk(self, n_samples, waveform_name='qudi_benchmark_chunk',
        ...
        def _count_chs(config):
            print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',35)
        ...
        def _get_largest_channel_config():
            print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',36)
        ...
        def _check_loaded(loaded_dict, should_load_list):
            print('C:\src\qudi\logic\pulsed\sequence_generator_logic.py  ',37)
            try:

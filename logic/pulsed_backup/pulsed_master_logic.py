...
class PulsedMasterLogic(GenericLogic):
    ...
    def analog_channels(self):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',0)
        return self.sequencegeneratorlogic().analog_channels

    @property
    def digital_channels(self):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',1)
        print(self.sequencegeneratorlogic().digital_channels, 'MASTER LOGIC self.sequencegeneratorlogic().digital_channels')###UNFUG
        return self.sequencegeneratorlogic().digital_channels

    @property
    def saved_pulse_blocks(self):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',2)
        return self.sequencegeneratorlogic().saved_pulse_blocks

    @property
    def saved_pulse_block_ensembles(self):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',3)
        return self.sequencegeneratorlogic().saved_pulse_block_ensembles

    @property
    def saved_pulse_sequences(self):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',4)
    ...
    def sampled_sequences(self):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',5)
    ...
    def sample_sequence(self, sequence_name, with_load=False):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',6)
        already_busy = self.status_dict['sampling_ensemble_busy'] or self.status_dict[
            'sampling_sequence_busy'] or self.sequencegeneratorlogic().module_state() == 'locked'
        if already_busy:
            self.log.error('Sampling of a different asset already in progress.\n'
    ...
    def sample_sequence_finished(self, sequence):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',7)
    ...
    def load_sequence(self, sequence_name):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',8)
        if self.status_dict['loading_busy']:
            self.log.error('Loading of a different asset already in progress.\n'
    ...
    def save_pulse_block(self, block_instance):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',9)
        """
    ...
    def save_block_ensemble(self, ensemble_instance):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',10)
        """
    ...
    def save_sequence(self, sequence_instance):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',11)
        """
    ...
    def delete_pulse_block(self, block_name):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',12)
        """
    ...
    def delete_all_pulse_blocks(self):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',13)
        """
    ...
    def delete_block_ensemble(self, ensemble_name):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',14)
        """
    ...
    def delete_all_block_ensembles(self):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',15)
        """
    ...
    def delete_sequence(self, sequence_name):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',16)
        """
    ...
    def delete_all_pulse_sequences(self):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',17)
        """
    ...
    def generate_predefined_sequence(self, generator_method_name, kwarg_dict=None, sample_and_load=False):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',18)
        """
    ...
    def predefined_sequence_generated(self, asset_name, is_sequence):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',19)
    ...
    def get_ensemble_info(self, ensemble):
        ...
        """
        print(self.sequencegeneratorlogic().get_ensemble_info(ensemble=ensemble))###UNFUG
        return self.sequencegeneratorlogic().get_ensemble_info(ensemble=ensemble)

    def get_sequence_info(self, sequence):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',20)
        """
    ...
    def analyze_block_ensemble(self, ensemble):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',21)
        """
        ...
        @return: number_of_samples (int): The total number of samples in a Waveform provided the
                 ...
                 digital_rising_bins (dict): Dictionary with keys being the digital channel
                                             ...
                                             channel.
        """
        print(self.sequencegeneratorlogic().analyze_block_ensemble(ensemble=ensemble), 'MASTER LOGIC self.sequencegeneratorlogic().analyze_block_ensemble(ensemble=ensemble)')###UNFUG
        return self.sequencegeneratorlogic().analyze_block_ensemble(ensemble=ensemble)

    def analyze_sequence(self, sequence):
        print('C:\src\qudi\logic\pulsed\pulsed_master_logic.py  ',22)
        """

...
class PulseBlock(object):
    ...
    def block_from_dict(block_dict):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',0)
...
class PulseBlockEnsemble(object):
    ...
    def __init__(self, name, block_list=None, rotating_frame=True):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',1)
        """
...
class PulseSequence(object):
    ...
    def sequence_from_dict(sequence_dict):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',2)
...
class PredefinedGeneratorBase:
    ...
    def __init__(self, sequencegeneratorlogic):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',3)
    ...
    def analyze_block_ensemble(self):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',4)
        return self.__sequencegeneratorlogic.analyze_block_ensemble

    @property
    def analyze_sequence(self):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',5)
    ...
    @property
    def save_block(self):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',6)
    ...
    def save_sequence(self):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',7)
    ...
    def channel_set(self):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',8)
    ...
    def microwave_channel(self):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',14)
    ...
    def _get_trigger_element(self, length, increment, channels):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',15)
        """
    ...
    def _add_trigger(self, created_blocks, block_ensemble):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',16)
    ...
    def _get_ensemble_count_length(self, ensemble, created_blocks):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',17)
        """
...
class PulseObjectGenerator(PredefinedGeneratorBase):
    ...
    def __init__(self, sequencegeneratorlogic):
        print('C:\src\qudi\logic\pulsed\pulse_objects.py  ',18)

...
def init_counter(kind, tagger, **kwargs):
    ...
    if kind == 'gated_counter_countbetweenmarkers':
        ...
        delayed_channel_400 = TimeTagger.DelayedChannel(
            tagger=tagger,
            input_channel=TimeTagger_channel_map['ssr_trigger'],
            delay=kwargs['delay']
        )

        vch1 = delayed_channel_400.getChannel()
        return TimeTagger.TimeDifferences(
            tagger,
            click_channel= TimeTagger_channel_map['apd1'],
            start_channel= vch1,
        ...
        # print('input_channel= ',TimeTagger_channel_map['apd1'])
    ...
    while True:
        ...
        try:
            ...
            if 'killme' in inc and inc['killme'] is True:
                ...
                available_counters = ['gated_counter', 'counter', 'odmr', 'pulsed', 'odmr_timedifferences', 'gated_counter_countbetweenmarkers','correlation','orabi_countbetweenmarkers']

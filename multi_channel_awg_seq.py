...
# import traceback
# import logging
# import agilent_m8190a
# import time
# import threading
# from AWG_M8190A_Elements import Sequence, SequenceStep, SequenceStepReuseSegment, WaveStep, __BLM__
#
...
#         if not hasattr(self, '_debug_mode') or self._debug_mode != misc.check_type(val, 'debug_mode', bool):
...
#                 out = agilent_m8190a.AWG(__AWG_INSTRUMENT_ADDRESS__[name], name, channel_numbers=__CH_DICT_FULL__[name])
#                 out.run = False

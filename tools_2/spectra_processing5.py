...
meas ='P5.5K_Excitation_HWP_13d_Paral_C_Emission_HWP(rotating) B2'
...
while i >= 0:
    ...
    v1 = np.sum(intensity[475:494])
    v1prime = np.sum(intensity[460:475])
    v2 = np.sum(intensity[740:760])
    v2prime = np.sum(intensity[530:550])

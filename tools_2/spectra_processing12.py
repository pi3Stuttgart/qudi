...
def PlotStokes(x,y,result,sh,fitlabel, plotcolor, title,cross=True, alpha=1, line_label=''):
    ...
    ax=plt.subplot(111,projection='polar')
    ax.plot(x,y, plotcolor+'o',linewidth=5,label=line_label+' raw data')
...
meas ='V1p_Circularlight_2_Emission_HWP_Para'
meas_laser ='laser_calibration 5.5K HWP_360 13_degree to C'
...
calibration_path= 'D:\\Data\\2016\\'+'2016-07-26\\'+'CREE\\'+meas_laser+'\\First_Measurement\\pys'
...
#plt.colorbar(ax2.imshow(cut_intensity))
...
FitStokesDictionary(laserdict,PLdict,q=q ,plottitle=plottitle)
rcp,lvp,lhp,lcp = FitJonesDictionary(laserdict,PLdict,q=q ,plottitle=plottitle)
